...
\caption{\label{org452cabf}
figures with captions}
\end{figure}


\subsection*{Table}
\label{sec:orgabb3a13}
...
\section*{Section title}
\label{sec:orgfd946b4}

\subsection*{Mathematics in latex}
\label{sec:orgefc545b}

Check equation \ref{eq:orgfae0362}.
...
\subsection*{Graph}
\label{sec:org1b010cd}

Check out the graph in figure \ref{org618939f}.
